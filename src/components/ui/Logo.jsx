        ...
        <div className='flex space-x-2'>
             <Link to="/" className="flex flex-row items-center space-x-2">
                ...
                <div className='flex flex-col'>
                    <span className="text-2xl md:text-3xl lg:text-4xl font-bai uppercase font-bold text-navyBlue 
                        tracking-[.5em]">
                        Radiant
                    </span>
                    {/* <hr className='border-1 border-azure w-[95%]' /> */}
                    <div className="flex justify-center items-center gap-2">
                        <hr className='border-[1.5px] border-navyBlue w-[37%] md:w-[40%]'/>
                        <span className='text-[0.65rem] md:text-[0.8rem] lg:text-base text-right pr-4 font-[600]
                        uppercase tracking-widest text-slate-500'>Dental Studio</span>
                    </div>
                </div>
            </Link>
        </div>
